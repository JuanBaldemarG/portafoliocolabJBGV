...
Repositorio académico del Dr. Juan Baldemar Garza Villegas para alumnos de posgrado y educación continua. Reúne 83 notebooks de Jupyter, datasets, materiales de apoyo y herramientas aplicadas a la analítica, la ciencia de datos, la inteligencia artificial y la minería de datos.
...
- [Módulo 2 — Canibalización geoespacial entre tiendas retail](notebooks/geoespacial/geoespacial_retail_cannibalizacion_colab.ipynb)
- [Módulo 3 — Análisis geoespacial en manufactura](notebooks/geoespacial/geoespacial_manufactura_colab.ipynb)
...
- [Módulo 2 — Reconocimiento de entidades (NER)](notebooks/mineria-texto/mineria_texto_ner_colab.ipynb)
- [Módulo 3 — Similitud semántica](notebooks/mineria-texto/mineria_texto_similitud_semantica_colab.ipynb)
